...
public class TreeMapExercises {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Original: " + productPrices);
        System.out.println("Submap: " + productPrices.subMap("Laptop", true, "Phone" , false));
        ...
        productPrices.descendingMap().forEach((key, value) -> System.out.println(key + ": $" + value));
