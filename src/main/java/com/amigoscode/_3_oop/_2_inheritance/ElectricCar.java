...
public class ElectricCar extends Vehicle{
    ...
    @Override
    public void start() {
        System.out.println("%s %s electric motor starting silently".formatted(make, model));
    }
    ...
    public void charge(int percent) {
        ...
        System.out.printf("Charging... Battery now at %d%n", this.batteryLevel);
    }
    ...
    public String getBatteryStatus() {
        return "Battery: %d%n".formatted(batteryLevel);
    }
